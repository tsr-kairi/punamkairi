...
export const serviceCategories: { id: ServiceCategory; label: string; description: string }[] = [
  ...
  { id: 'FACIALS', label: 'Facials & Skin Glow', description: 'Pre-Puja luxury facials: 24K Gold, Diamond De-Tan, Hydra-Dew, O3+ & Organic Herbal — FLAT 10% OFF (15 Sep – 15 Oct).' },
  { id: 'THREADING', label: 'Threading & Grooming', description: 'Precision eyebrow architecture, full face hair removal & calming aloe therapy — FLAT 10% OFF (15 Sep – 15 Oct).' },
...
export const servicesData: ServiceItem[] = [
  ...
  // FACIALS & SKIN GLOW (NEW DEDICATED CATEGORY)
  {
    ...
    tagline: 'Royal festival radiance with 24K gold foil infusion • 10% OFF (15 Sep – 15 Oct).',
    ...
    price: '10% OFF Puja Special',
    priceType: 'starting',
    duration: '60 - 75 Mins',
    badge: '10% OFF (15 Sep - 15 Oct)',
    popular: true,
  ...
  },
  {
    ...
    category: 'FACIALS',
    categoryLabel: 'Facials & Skin Glow',
    tagline: 'Erase sun tan & reveal diamond-bright skin • 10% OFF (15 Sep – 15 Oct).',
  ...
  },
  {
    ...
    category: 'FACIALS',
    categoryLabel: 'Facials & Skin Glow',
    tagline: 'Plump, dewy, glass-like complexion for festive nights • 10% OFF (15 Sep – 15 Oct).',
  ...
  },
  {
    ...
    category: 'FACIALS',
    categoryLabel: 'Facials & Skin Glow',
    tagline: 'High-impact glow & dark spot correction • 10% OFF (15 Sep – 15 Oct).',
  ...
  },
  {
    ...
    category: 'FACIALS',
    categoryLabel: 'Facials & Skin Glow',
    tagline: 'Gentle, soothing botanical care for sensitive skin • 10% OFF (15 Sep – 15 Oct).',
  ...
  },
  {
    ...
    category: 'FACIALS',
    categoryLabel: 'Facials & Skin Glow',
    tagline: 'Quick 30-minute skin prep & deep blackhead removal • 10% OFF (15 Sep – 15 Oct).',
  ...
  // THREADING & GROOMING (NEW DEDICATED CATEGORY)
  {
    ...
    tagline: 'Flawlessly sculpted brow arches that frame your face • 10% OFF (15 Sep – 15 Oct).',
  ...
  },
  {
    ...
    category: 'THREADING',
    categoryLabel: 'Threading & Grooming',
    tagline: 'Clean, smooth canvas for seamless lipstick application • 10% OFF (15 Sep – 15 Oct).',
  ...
  },
  {
    ...
    category: 'THREADING',
    categoryLabel: 'Threading & Grooming',
    tagline: 'Silky smooth velvet canvas for 4K HD makeup • 10% OFF (15 Sep – 15 Oct).',
  ...
  },
  {
    ...
    category: 'THREADING',
    categoryLabel: 'Threading & Grooming',
    tagline: 'Clean hairline contouring & sideburn shaping • 10% OFF (15 Sep – 15 Oct).',
  ...
  },
  {
    ...
    category: 'THREADING',
    categoryLabel: 'Threading & Grooming',
    tagline: 'Complete threading + anti-redness calming cooling pack • 10% OFF (15 Sep – 15 Oct).',
